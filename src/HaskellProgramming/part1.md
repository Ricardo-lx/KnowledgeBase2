...
CHAPTER 1. ANYTHING FROM ALMOST NOTHING 5
...
CHAPTER 1. ANYTHING FROM ALMOST NOTHING 13
...
CHAPTER 1. ANYTHING FROM ALMOST NOTHING 21
...
CHAPTER 1. ANYTHING FROM ALMOST NOTHING 27
1.12 Answers
...
CHAPTER 1. ANYTHING FROM ALMOST NOTHING 32
term.
(𝜆𝑥.𝑥+1)
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 38
...
The normal form of 1 + 1is2. Why? Because the expression 1
+ 1can be evaluated or reduced by applying the addition oper-
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 43
2.4 Functions
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 44
9
Prelude> (4 + 5) * 3
27
Prelude> (10 + 5) * 3
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 45
Defining functions
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 46
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 47
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 48
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 49
triple2
-- [triple x = x * 3; x:= 2]
2*3
6
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 50
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 51
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 52
1001.0
Prelude> 476 - 36
440
Prelude> 10 / 4
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 53
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 54
:info (*)
infixl 7*
-- [1] [2] [3]
:info (+) (-)
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 55
(2*3)*4
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 56
2417851639229258349412352
Prelude> (2 ^ 3) ^ 4
4096
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 57
b)(8 + 7) * 9
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 58
60
Prelude> y
10
Prelude> myResult
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 59
Troubleshooting
...
introduced by letordo, you might see something like this:

CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 60
let
x=3
y=4
-- or
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 61
foox=
lety=x*2
z=x^2
in2*y*z
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 62
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 63
x=10
*5+y
-- or
x=10
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 64
[1 of 1] Compiling Learn
code/learn.hs:11:1:
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 65
-- learn.hs
moduleLearnwhere
x=10*5+y
myResult =x*5
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 66
-learn.hs
moduleLearnwhere
x=10*5+y
myResult =x*5
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 67
[1 of 1] Compiling Learn
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 68
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 69
Prelude> div 1 1
1
Prelude> mod 1 1
0
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 70
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 71
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 72
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 73
Prelude> mod 21 12
9
Prelude> rem 21 12
9
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 74
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 75
...
Prelude> (-5) `rem` (-2)
-1
Figuring out when you need modtakes some experience.

CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 76
Negative numbers
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 77
Prelude> 1000 + (-9)
991
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 78
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 79
(+) :: a -> a -> a
infixl 6 +
Prelude> :info (-)
class Num a where
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 80
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 81
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 82
(2^)$(*30)$2+2
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 83
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 84
1
Prelude> (-) 2 1
1
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 85
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 86
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 87
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 88
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 89
...
Prelude> mult1
30
The prompt changes to *Maininstead of Prelude to indicate
that you have a module called Mainloaded.
Rewrite with whereclauses:
1.letx=3; y=1000inx*3+y
2.lety=10; x=10*5+yinx*5
3.letx=7
y=negate x
z=y*10
inz/x+y
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 90
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 91
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 92
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 93
10+waxOn
-- or
(+10) waxOn
-- or
...
triple function. Remember: You don’t need letand the

CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 94
...
CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 95
...
ated any further. 2 * 2is an expression, but not a value,

CHAPTER 2. BASIC EXPRESSIONS AND FUNCTIONS 96
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 98
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 99
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 100
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 101
"hello world!"
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 102
-- print1.hs
modulePrint1where
main::IO()
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 103
Ok, modules loaded: Print1.
λ> main
hello world!
λ>
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 104
-- print2.hs
modulePrint2where
main::IO()
main= do
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 105
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 106
-- print3.hs
modulePrint3where
myGreeting ::String
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 107
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 108
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 109
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 110
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 112
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 113
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 114
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 115
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 119
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 120
Prelude> 'c' : "hris"
"chris"
Prelude> 'P' : ""
"P"
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 121
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 122
...
represented by a linked-list of Charvalues, aka [Char] .

CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 129
...
CHAPTER 3. SIMPLE OPERATIONS WITH TEXT 130
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 132
4.1 Basic Datatypes
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 133
4.2 What are types?
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 134
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 135
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 136
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 137
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 138
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 139
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 140
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 141
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 142
127
Prelude> 128 :: Int8
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 143
...
-9223372036854775808
3The representation used for the fixed-size Inttypes is two’s complement .

CHAPTER 4. BECAUSE PIGS CAN’T FLY 144
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 145
Fractional numbers
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 146
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 147
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 148
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 149
Prelude> 'a' == 'a'
True
Prelude> 'a' == 'b'
False
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 150
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 151
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 152
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 153
True :: Bool
Prelude> :t "Julie"
"Julie" :: [Char]
...
logic. How do we use Booland these associated functions?

CHAPTER 4. BECAUSE PIGS CAN’T FLY 154
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 155
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 156
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 157
Prelude> let x = 0
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 158
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 159
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 160
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 161
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 162
λ> (,) True 'c'
(True,'c')
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 163
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 164
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 165
4.8 Lists
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 166
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 167
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 168
a)length [1, 2, 3, 4, 5]
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 169
Prelude> let x = 5
Prelude> x + 3 == 5
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 170
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 171
f(a b)=A
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 172
c)(+)::num a=>a->a->a
d)(+)::Numa=>a->a->a
e)(+)::a->a->a
4.10 Definitions
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 173
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 174
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 175
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 176
...
CHAPTER 4. BECAUSE PIGS CAN’T FLY 177
...
withmonomorphic , “made of one form.”
...
Intis not a Fractional number, this function won’t work:
...
3https://twitter.com/SixBitProxyWax
...
applications of the function. Parametricity4tells us that
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 248
6.1 Typeclasses
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 249
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 250
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 251
...
6.instance Show Bool –Showrenders things into strings.

CHAPTER 6. LESS AD-HOC POLYMORPHISM 252
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 253
(/=) :: a -> a -> Bool
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 254
Prelude> 132 == 132
True
Prelude> 132 /= 132
False
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 255
(==) ::Eqa=>a->a->Bool
-- if we specialized (==)
-- for [Char] aka String
(==)
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 256
with actual type ‘[Char]’
...
constituent values 𝑎and𝑏. This is why this works:

CHAPTER 6. LESS AD-HOC POLYMORPHISM 257
Prelude> (1, 'a') == (2, 'b')
False
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 258
Eq instances
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 259
dataTrivial =
Trivial
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 260
...
Prelude> Trivial' == Trivial'
True
Let’s drill down a bit into how this instance stuﬀ works:

CHAPTER 6. LESS AD-HOC POLYMORPHISM 261
instance EqTrivial where
-- [1] [2] [3] [4]
Trivial' ==Trivial' =True
-- [5] [6] [7] [8]
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 262
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 263
dataDayOfWeek =
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 264
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 265
Prelude> Date Thu 10
<interactive>:26:1:
...
had made a mistake in the Eqinstance?

CHAPTER 6. LESS AD-HOC POLYMORPHISM 266
dataDayOfWeek =
Mon|Tue|Weds|Thu|Fri|Sat|Sun
instance EqDayOfWeek where
(==)MonMon=True
...
because we wanted stuﬀ to blow up at runtime. So what gives?

CHAPTER 6. LESS AD-HOC POLYMORPHISM 267
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 268
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 269
f::Int->Bool
f1=True
f2=True
f3=True
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 270
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 271
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 272
In the expression:
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 273
2.dataTwoIntegers =
TwoInteger Integer
3.dataStringOrInt =
TisAnInt Int
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 275
...
quotRem anddivMod . What do you think those functions do? Test

CHAPTER 6. LESS AD-HOC POLYMORPHISM 276
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 278
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 279
...
4The Haskell Report is the standard that specifies the language and standard libraries

CHAPTER 6. LESS AD-HOC POLYMORPHISM 280
default Num Integer
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 281
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 282
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 283
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 284
Num a1 => a1 -> a1
Expected type: a1 -> a1
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 285
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 286
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 287
Prelude> max 7 8
8
Prelude> min 10 (-10)
-10
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 288
-- [4]
In a stmt of an interactive GHCi command: print it
-- [ 5 ]
...
instance of Show. The error message is because maxapplied to

CHAPTER 6. LESS AD-HOC POLYMORPHISM 289
...
it into the file you’re currently using, or derive an Eqinstance

CHAPTER 6. LESS AD-HOC POLYMORPHISM 290
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 291
...
Eqinstances, whether the Eqinstances are derived or manually

CHAPTER 6. LESS AD-HOC POLYMORPHISM 292
...
But what if we add Ordinstead of Eqas it asks?

CHAPTER 6. LESS AD-HOC POLYMORPHISM 293
check'::Orda=>a->a->Bool
check'a a'=a==a'
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 294
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 295
enumFrom :: a -> [a]
enumFromThen :: a -> a -> [a]
enumFromTo :: a -> a -> [a]
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 296
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 297
...
it as aString , allowing it to be printed.

CHAPTER 6. LESS AD-HOC POLYMORPHISM 298
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 299
...
This result is an IOaction that returns a value of the type ().

CHAPTER 6. LESS AD-HOC POLYMORPHISM 300
...
producing aString , which may require performing side eﬀects

CHAPTER 6. LESS AD-HOC POLYMORPHISM 301
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 302
dataMood=Blah
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 303
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 304
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 305
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 306
newtype Year=
YearInteger
deriving (Eq,Show)
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 307
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 308
instance Numberish Agewhere
fromNumber n =Agen
toNumber ( Agen)=n
defaultNumber =Age65
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 309
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 310
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 311
add::Numa=>a->a->a
addx y=x+y
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 312
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 313
add::Int->Int->Int
addx y=x+y
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 314
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 315
a)Ord a => a -> a -> Bool
b)Ord a => Int -> Bool
c)Ord a => a -> Char
d)Ord a => Char -> [Char]
...
instance of Numbefore you may do so.
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 325
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 326
...
CHAPTER 6. LESS AD-HOC POLYMORPHISM 327
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 329
7.1 Make it func-y
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 330
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 331
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 332
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 333
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 334
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 335
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 336
bindExp ::Integer ->String
bindExp x=
letz=y+xin
lety=5in
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 337
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 338
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 339
100
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 340
...
CHAPTER 7. MORE FUNCTIONAL PATTERNS 341
